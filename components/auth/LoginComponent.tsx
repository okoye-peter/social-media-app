...
const LoginComponent = ({ onChangeCard }: { onChangeCard: (card: string) => void }) => {
            ...
            <div className="w-full max-w-md bg-white rounded-3xl shadow-2xl p-6">
                ...
                <form onSubmit={handleEmailLogin} className="space-y-3">
                    ...
                    <Button
                        type="submit"
                        disabled={loading}
                        className="w-full h-10 bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 text-white font-semibold text-sm rounded-lg shadow-lg hover:shadow-xl transition-all"
                    >
                ...
                <div className="mt-4 pt-4 border-t border-gray-200">
                    <p className="text-center text-sm text-gray-600">
                        ...
                        <Button variant={'link'} onClick={() => onChangeCard('register')} className="text-indigo-600 hover:text-indigo-700 font-semibold">
                            Sign up
                        </Button>
                    </p>
                </div>
